...
508 KB of WebAssembly — 175 KB brotli (`-q 11`) over the wire, client included — no
wasm-bindgen, no build step. The module alone is 151 KB of that, and 120 KB built
...
**Container.** 2.92 MB, and the `Dockerfile` is two-stage: static musl build
...
| **Runtime size** | 508 KB wasm + 88 KB client (175 KB brotli served) · 1072–1526 KB binary · 2.92 MB container image |
