...
505 KB of WebAssembly — 174 KB brotli (`-q 11`) over the wire, client included — no
wasm-bindgen, no build step. The module alone is 150 KB of that, and 120 KB built
...
| **Runtime size** | 505 KB wasm + 88 KB client (174 KB brotli served) · 1072–1509 KB binary · 2.92 MB container image |
