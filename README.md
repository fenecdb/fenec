...
412 KB of WebAssembly — 134 KB brotli (`-q 11`) over the wire, client included — no
...
| **Runtime size** | 412 KB wasm + 66 KB client (134 KB brotli served) · 684–927 KB binary · 1.31 MB container image |
