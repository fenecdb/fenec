...
474 KB of WebAssembly — 156 KB brotli (`-q 11`) over the wire, client included — no
...
| **Runtime size** | 474 KB wasm + 72 KB client (156 KB brotli served) · 878–1316 KB binary · 2.19 MB container image |
