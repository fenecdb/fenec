...
508 KB of WebAssembly — 174 KB brotli (`-q 11`) over the wire, client included — no
...
| **Runtime size** | 508 KB wasm + 88 KB client (174 KB brotli served) · 1072–1526 KB binary · 2.92 MB container image |
