...
445 KB of WebAssembly — 147 KB brotli (`-q 11`) over the wire, client included — no
...
| **Runtime size** | 445 KB wasm + 72 KB client (147 KB brotli served) · 829–1251 KB binary · 2.19 MB container image |
