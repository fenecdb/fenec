...
499 KB of WebAssembly — 171 KB brotli (`-q 11`) over the wire, client included — no
...
| **Runtime size** | 499 KB wasm + 88 KB client (171 KB brotli served) · 1056–1493 KB binary · 2.84 MB container image |
