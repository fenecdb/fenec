...
453 KB of WebAssembly — 150 KB brotli (`-q 11`) over the wire, client included — no
...
| **Runtime size** | 453 KB wasm + 72 KB client (150 KB brotli served) · 829–1251 KB binary · 2.19 MB container image |
