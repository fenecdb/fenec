...
473 KB of WebAssembly — 155 KB brotli (`-q 11`) over the wire, client included — no
...
| **Runtime size** | 473 KB wasm + 72 KB client (155 KB brotli served) · 878–1316 KB binary · 2.19 MB container image |
